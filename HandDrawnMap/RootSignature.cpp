...
RootSignature::RootSignature()
{
    ...
    // ルートパラメータ
    //CD3DX12_ROOT_PARAMETER rootParam[2] = {}; // 定数バッファとテクスチャの2つ
    CD3DX12_ROOT_PARAMETER rootParam[3] = {}; // 定数バッファとテクスチャの2つ
    ...
    rootParam[2].InitAsDescriptorTable(std::size(tableRange), tableRange, D3D12_SHADER_VISIBILITY_ALL);
